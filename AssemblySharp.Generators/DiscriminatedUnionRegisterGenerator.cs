...
public class DiscriminatedUnionRegisterGenerator : IIncrementalGenerator
{
	...
	{
		return syntaxNode is GenericNameSyntax genericNameSyntax && genericNameSyntax.Identifier.Text.Equals("Register") && genericNameSyntax.TypeArgumentList.Arguments.Count > 0;
	}
...
{registerImplicitOperators}
	...
	{
		var genericRegisterClassesInUseProvider = context
		...
		context.RegisterSourceOutput(
			genericRegisterClassesInUseProvider,
			(sourceProductionContext, genericRegisterClassesInUse) =>
			{
